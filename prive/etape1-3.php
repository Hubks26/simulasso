...
<head>
    ...
    <title>Etape 1-3 - Simul'asso</title>
...
<body>
    ...
    <main class="fond-bleu-clair">
        ...
        <section class="section has-text-centered">
            <h1>Quel sera l'activité de votre association ?</h1>
        </section>

        <section class="section">
            <p class="petit">
                L’activité indiquée servira de base à la rédaction de l’objet social. Vous pourrez le préciser dans un second temps
            </p>

            <form method="post" action="./../traitements/etape1/tt-etape1-3.php">
                <input type="text" placeholder="Activité de l'association" class="input input-assoc" name="activite-association" required>
                <br>
                <br>
